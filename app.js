        ...
        try {
          ...
          for (const pur of newPurchases) {
            ...
            const allMatched = emergencyEntries.filter(e => {
              ...
              if (process2) return true; // HRN match doesn't need item name at all
            ...
            allMatched.forEach(matched => {
              ...
              matched.name              = matched.name || pur.itemName; // fill in name from the matched purchase, if it wasn't set
