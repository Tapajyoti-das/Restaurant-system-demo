...
async function cancelMyOrder(orderId) {
  ...
  const result = await sbUpdateOrder(orderId, {status:'Cancelled', cancelReason:'Cancelled by customer'});
  if(result === null) {
    ...
    // admin/DB still shows Pending.
    showToast('⚠️ Could not cancel your order. Please check your connection and try again, or contact support.','error');
    return;
  }
  o.status = 'Cancelled';
