...
function showEventsTab(tab, btn) {
  try {
  ['list','birthday','anniversary','marriage','riceceremony','zones','blocklist','reports'].forEach(t=>{
  ...
  if(btn) btn.classList.add('active');
  const catMap = { birthday:'Birthday', anniversary:'Anniversary', marriage:'Marriage', riceceremony:'Rice Ceremony' };
...
const FOLLOWUP_CATEGORIES = ['Birthday','Anniversary','Marriage','Rice Ceremony'];
