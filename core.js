...
window.addEventListener('DOMContentLoaded', async () => {
  ...
  // If the customer scanned a table's QR code (?table=T1), auto-select
  // Dine-In + that exact table, so they don't have to pick it themselves.
  try {
        ...
        setTimeout(() => {
          try {
            ...
            if(section && !document.getElementById('qrTableBanner')) {
              ...
              banner.textContent = '🪑 You scanned Table ' + matchedTable.num + ' — your order will be served here!';
